...
Implements constants and dataclasses for working with SMPL [1, 2].

[1] Loper, Matthew, et al. "SMPL: A skinned multi-person linear model." ACM transactions
    on graphics (TOG) 34.6 (2015): 1-16.
[2] Mahmood, Naureen, et al. "AMASS: Archive of motion capture as surface shapes."
